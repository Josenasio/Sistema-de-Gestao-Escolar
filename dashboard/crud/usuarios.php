...
$query = "
    SELECT usuarios.*, escola.nome AS nome_escola 
    FROM usuarios 
    LEFT JOIN escola ON usuarios.id_escola = escola.id 
    WHERE usuarios.tipo = 'direcao'
";
...
<div class="container">
    <h1 class="text-center text-primary my-5">Lista Direção da Escola</h1>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php while ($usuario = $result->fetch_assoc()): ?>
                    <tr>
                    <td style="color: #ffff;"><?php echo htmlspecialchars($usuario['nome_escola'] ?? 'Não atribuída'); ?></td>
                        <td style="color: #ffff;"><?php echo htmlspecialchars($usuario['nome']); ?></td>
                        <td style="color: #ffff;"><?php echo htmlspecialchars($usuario['email']); ?></td>
                    
                        <td style="color: red;">*******</td>
                        <td>
                            <!-- Botões para Editar e Deletar -->
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?php echo $usuario['id']; ?>" data-nome="<?php echo htmlspecialchars($usuario['nome']); ?>" data-email="<?php echo htmlspecialchars($usuario['email']); ?>">Editar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Editar Diretor(a) da Escola</h5>
