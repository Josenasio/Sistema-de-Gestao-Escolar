...
$query = "SELECT aluno.id, aluno.nome, aluno.genero, escola.nome AS escola_nome, classe.nivel_classe AS classe_nome, 
          ...
          aluno.idade, aluno.endereco, aluno.contato_encarregado, aluno.nome_encarregado, aluno.situacao_economica, aluno.tipo_deficiencia
          FROM aluno
          ...
          WHERE aluno.deficiente = 1"; // Mantém a condiçao para alunos deficientes, sem verificar NULL
...
<head>
    <meta charset="UTF-8">
    <title>Filtro de Alunos com Deficiência</title>
...
<h1>Filtro de Alunos com Deficiência</h1>
            ...
            <div class="card-body">
                <form id="field-selector-form">
                    ...
                    $fields = [
                        ...
                        'tipo_deficiencia' => 'Endereço',
                        'situacao_economica' => 'NIF',
                        'endereco' => 'Gênero',
                        'distrito_nome' => 'Data do Contrato',
                        'religiao_nome' => 'Funçao',
                        'nome_encarregado' => 'Estado Civil',
                        'contato_encarregado' => 'Nº Conta Bancária',
                        'escola_nome' => 'Ano de Serviço',
                        'classe_nome' => 'Ano de Inicio de Serviço',
                        'curso_nome' => 'Nivel Acadêmico'
...
<div class="student-list">
    <table id="table-results">
        <tr>
            ...
            <th>Idade</th>
            <th>Gênero</th>
            <th>Tipo Deficiência</th>
            <th>Situaçao Económica</th>
            <th>Endereço</th>
            <th>Distrito</th>
            <th>Religiao</th>
            <th>Encarregado</th>
            <th>Cont. Encarregado</th>
            <th>Escola</th>
            <th>Classe</th>
            <th>Curso</th>
        </tr>
        ...
        <?php else: ?>
            <?php foreach ($alunos as $aluno): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($aluno['genero'] ?? 'N/A'); ?></td>
                    <td><?= htmlspecialchars($aluno['tipo_deficiencia'] ?? 'N/A'); ?></td>
