...
$notas_sql = "SELECT id_aluno, id_disciplina, nota FROM notas_exame WHERE fase = 1 ";
...
<br>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">Notas de Exame 1ª-Fase</h1>
        <form action="salvar_notas_exame.php" method="POST" onsubmit="return validarFormulario(event)">
